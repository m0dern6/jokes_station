...
class JokesCard extends StatefulWidget {
  const JokesCard({super.key});

  @override
  State<JokesCard> createState() => _JokesCardState();
}

class _JokesCardState extends State<JokesCard> {
